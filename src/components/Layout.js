      ...
      <Sidebar isOpen={sidebarOpen}>
        ...
        <Nav>
          <NavGroup>
            ...
            <NavItem to="/counseling-requests" className={isActive('/counseling-requests') ? 'active' : ''}>
              <Icon>📝</Icon> 상담 요청 관리
            </NavItem>
          </NavGroup>
          
          <NavGroup>
            <NavGroupTitle>일정 관리</NavGroupTitle>
            <NavItem to="/calendar" className={isActive('/calendar') ? 'active' : ''}>
              <Icon>📅</Icon> 상담 일정
            </NavItem>
          </NavGroup>
          
          <NavGroup>
            <NavGroupTitle>보고서</NavGroupTitle>
